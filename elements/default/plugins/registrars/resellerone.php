...
//get open srs params
$username     = $this->dr_vals['resellerone']['login'];
$private_key  = $this->dr_vals['resellerone']['password'];
...
{
    $this->orders->update(array("sub_id"=>$sub_id,"dom_reg_comp"=>1, "dom_reg_result"=>$id, "dom_registrar"=>"resellerone"));
