...
/*
 * Class to do all worldpay
 * worldpay Version 1.0
 */
class worldpay
{
	/*
	 * Constructor
	 */
	function worldpay($demo_mode= 0)
	{
		$this->demo_mode  = $demo_mode;
		$this->pay_url    = "https://select.worldpay.com/wcc/purchase";
	}
	/*
	...
	function ipn(& $BL)
	{
		$this->item_number    = $_POST['M_item_no'];
