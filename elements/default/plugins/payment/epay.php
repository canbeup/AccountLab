...
class epay
{
	 ...
	 * Constructor
	 */
	function epay($demo_mode= 0)
	{
		$this->demo_mode = $demo_mode;
		$this->pay_url   = "http://www.epay.vg/";
	}
	/*
	...
	{
		$this->_POST1 = array ();
		$this->_POST1['EPAY_MERCHANT_ID'] = $pp_vals['epay_id'];
        $this->_POST1['EPAY_CURRENCY']    = strtolower($pp_vals['epay_currency']);
        $this->_POST1['EPAY_AMOUNT']      = number_format($_POST['gross_amount'],2);
        $this->_POST1['EPAY_USER_MEMO']   = $_POST['desc'];
