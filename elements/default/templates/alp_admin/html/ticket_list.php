...
<div id="content">
    <div id="display_list">
    <?phpphp if(!isset($REQUEST['ticket_status']) || $REQUEST['ticket_status']!=3){ ?>
      <div class="tabs2" name='tt1' id='tt1' onmouseover="javascript:this.className='tabs1';" onmouseout="javascript:this.className='tabs2';" ><?phpphp echo $BL->props->lang['Open_tickets']; ?></div>
      <div class="tab_separator">&nbsp;</div>
      <div class="tabs" name='tt2' id='tt2' onmouseover="javascript:this.className='tabs1';" onmouseout="javascript:this.className='tabs';" ><a href="admin.php?cmd=ticket&ticket_status=3" class="add_link"><?phpphp echo $BL->props->lang['Closed_tickets']; ?></a></div>
      <div class="tab_separator">&nbsp;</div> 
    <?phpphp } ?> 
    <?phpphp if(isset($REQUEST['ticket_status']) && $REQUEST['ticket_status']==3){ ?>
      <div class="tabs" name='tt1' id='tt1' onmouseover="javascript:this.className='tabs1';" onmouseout="javascript:this.className='tabs';" ><a href="admin.php?cmd=ticket" class="add_link"><?phpphp echo $BL->props->lang['Open_tickets']; ?></a></div>
      <div class="tab_separator">&nbsp;</div>
      <div class="tabs2" name='tt2' id='tt2' onmouseover="javascript:this.className='tabs1';" onmouseout="javascript:this.className='tabs2';" ><?phpphp echo $BL->props->lang['Closed_tickets']; ?></div>
      <div class="tab_separator">&nbsp;</div> 
    <?phpphp } ?> 
    </div>
	<div id="display_list">
    <?phpphp include $BL->props->get_page("templates/alp_admin/html/_tickets.php"); ?>
    ...
    &nbsp;
    <img src='elements<?phpphp echo PATH_SEP; ?>default<?phpphp echo PATH_SEP; ?>templates<?phpphp echo PATH_SEP; ?>alp_admin<?phpphp echo PATH_SEP; ?>images<?phpphp echo PATH_SEP; ?>delete.gif'> <?phpphp echo $BL->props->lang['Close']; ?>
    </div>
    </td>
    </tr>
    </table>		
