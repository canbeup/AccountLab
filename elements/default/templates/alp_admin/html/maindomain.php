...
<div id="content">
    <div id="display_list">
      <div class="tabs" name='tt1' id='tt1' onmouseover="javascript:this.className='tabs1';" onmouseout="javascript:this.className='tabs';" ><a href="admin.php?cmd=subdomains" class="add_link"><?phpphp echo $BL->props->lang['~subdomains']; ?></a></div>
				...
				<tr>
				    ...
				    <table width='100%' border='0' cellspacing='0' cellpadding='0'>
                      <tr> 
						...
						<div id="form1_field"> 
                            <input name='maindomain' type='text' class='search' id='maindomain' size='20' value='<?phpphp if($cmd=="editmaindomain")echo $maindomain['maindomain']; ?>' />
                          </div></td>
                      </tr>
                      <tr> 
                    ...
                    <?phpphp foreach($BL->props->cycles as $ck=>$cv){ ?>
                      <tr> 
                        ...
                        <td class='text_grey'>
						<div id="form1_label">
						<?phpphp echo $BL->props->lang[$cv]." (".$conf['symbol'].")"; ?>
						</div>
						<div id="form1_field">
                            <input name='<?phpphp echo $cv; ?>' type='text' class='search' size='10' value='<?phpphp if($cmd=="editmaindomain")echo $maindomain_cycles[$cv]; ?>' />
                          </div></td>
                      </tr>
                      <tr> 
                        <td colspan='2' class='text_grey'>
                      ...
                      <tr> 
                        ...
                        <td class='text_grey'>
						<div id="form1_label">
						<?phpphp echo $BL->props->lang['reserved_names']; ?>
						</div>
						<div id="form1_field">
                            <input name='reserved_names' type='text' class='search' id='reserved_names' size='20' value='<?phpphp if($cmd=="editmaindomain")echo $maindomain['reserved_names']; ?>'>
                          </div></td>
                      </tr>
                      <tr> 
                      ...
                      <tr> 
						...
						<div id="form1_field">
                            <?phpphp if($cmd=="editmaindomain"){ ?>
                        	<input type='hidden' name='main_id' value='<?phpphp echo $maindomain['main_id']; ?>' />
                            <?phpphp } ?>
                            <input type='hidden' name='cmd' value='<?phpphp echo $cmd; ?>' />
                            <input name='submit' type='submit' class='search1' value='<?phpphp if($cmd=="editmaindomain")echo $BL->props->lang['Update'];else echo $BL->props->lang['add']; ?>' />
                          </div></td>
                      </tr>
                    </table>
				  </form>
