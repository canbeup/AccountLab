...
<div id="content">
    <div id="display_list">
      ...
      <div class="tab_separator">&nbsp;</div>
      <div class="tabs" name='tt3' id='tt3' onmouseover="javascript:this.className='tabs1';" onmouseout="javascript:this.className='tabs';" ><a href="admin.php?cmd=send_disc_token" class="add_link"><?phpphp echo $BL->props->lang['send_disc_token']; ?></a></div>
      <div class="tab_separator">&nbsp;</div>      
    </div>
	<div id="display_list">
				...
				<tr>
				    ...
				    <table width='100%' border='0' cellspacing='0' cellpadding='0'>
                      <tr> 
						...
						<div id="form1_field">
                            <input name='disc_token_name' type='text' class='search' id='disc_token_name' size='20' value='<?phpphp if($cmd=="edit_disc_token")echo $disc_token['disc_token_name']; ?>' />
                          </div></td>
                      </tr>
                      <tr> 
...
height='18'></div></td>
						...
						<div id="form1_field">
                            %<input name='disc_token_discount' type='text' class='search' id='disc_token_discount' size='7' value='<?phpphp if($cmd=="edit_disc_token")echo $disc_token['disc_token_discount']; ?>' />
                          </div></td>
                      </tr>
                      <tr> 
                        <td colspan='2' class='text_grey'><img src='elements<?phpphp echo PATH_SEP; ?>default<?phpphp echo PATH_SEP; ?>templates<?phpphp echo PATH_SEP; ?>alp_admin<?phpphp echo PATH_SEP; ?>images<?phpphp echo PATH_SEP; ?>menu_line_lightgreen-long.jpg' width='100%' height='1' /></td>
...
height='18'></div></td>
						...
						<div id="form1_field">
                            ...
                            <option value='1' <?phpphp if($cmd=="edit_disc_token" && $disc_token['disc_token_domain']==1)echo "selected=\"selected\""; ?>><?phpphp echo $BL->props->lang['Yes']; ?></option>
                            <option value='0' <?phpphp if($cmd=="edit_disc_token" && $disc_token['disc_token_domain']==0)echo "selected=\"selected\""; ?>><?phpphp echo $BL->props->lang['No']; ?></option>
                            </select>
                        </div>
                        </td>
                      </tr>
...
height='18'></div></td>
						...
						<div id="form1_field">
                            ...
                            <option value='1' <?phpphp if($cmd=="edit_disc_token" && $disc_token['disc_token_addons']==1)echo "selected=\"selected\""; ?>><?phpphp echo $BL->props->lang['Yes']; ?></option>
                            <option value='0' <?phpphp if($cmd=="edit_disc_token" && $disc_token['disc_token_addons']==0)echo "selected=\"selected\""; ?>><?phpphp echo $BL->props->lang['No']; ?></option>
                            </select>
                        </div>
                        </td>
                      </tr>
...
height='18'></div></td>
                      ...
                      <tr> 
						...
						<div id="form1_field"> 
                            <?phpphp if($cmd=="edit_disc_token"){ ?>
                        	<input type='hidden' name='disc_token_id' value='<?phpphp echo $disc_token['disc_token_id']; ?>' />
                            <?phpphp } ?>
                            <input type='hidden' name='cmd' value='<?phpphp echo $cmd; ?>' />
                            <input name='submit' type='submit' class='search1' value='<?phpphp if($cmd=="edit_disc_token")echo $BL->props->lang['Update'];else echo $BL->props->lang['add']; ?>' />
                          </div></td>
                      </tr>
                    </table>
				  </form>
