...
<div id="content">
    <div id="display_list">
      <div class="tabs" name='tt1' id='tt1' onmouseover="javascript:this.className='tabs1';" onmouseout="javascript:this.className='tabs';" ><a href="admin.php?cmd=tax" class="add_link"><?phpphp echo $BL->props->lang['~tax']; ?></a></div>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="list_table">
                ...
                <tr>
                    ...
                    <table width='100%' border='0' cellspacing='0' cellpadding='0'>
                        ...
                        <td class='text_grey'>
                        <div id="form1_label">
                        <?phpphp echo $BL->props->lang['Tax_Name']; ?>
                        </div>
                        <div id="form1_field">
                          <input name='tax_name' type='text' class='search' id='tax_name' size='20' value='<?phpphp if($cmd=="edittax") echo $tax['tax_name']; ?>' />
                        </div>
                        </td>
                      </tr>
                      <tr> 
                      ...
                      <tr> 
                        ...
                        <td class='text_grey'>
                        <div id="form1_label">
                        <?phpphp echo $BL->props->lang['Tax_Amount']; ?> (%)
                            </div>
                            <div id="form1_field">
                            <input name='tax_amount' type='text' class='search' id='tax_amount' size='10' value='<?phpphp if($cmd=="edittax") echo $tax['tax_amount']; ?>' />
                          </div>
                         </td>
                      </tr>
                      <tr> 
                      ...
                      <tr> 
                        ...
                        <td class='text_grey'>
                        <div id="form1_label">
                        <?phpphp echo $BL->props->lang['add']; ?> / <?phpphp echo $BL->props->lang['subtruct']; ?>
                        </div>
                        <div id="form1_field">
                          <select name='tax_add_sub' class='search' id='tax_add_sub'>
                            <option value='A' <?phpphp if($cmd=="edittax"){if($tax['tax_add_sub']=="A") echo "selected=\"selected\"";} ?>><?phpphp echo $BL->props->lang['add']; ?></option>
                            <option value='S' <?phpphp if($cmd=="edittax"){if($tax['tax_add_sub']=="S") echo "selected=\"selected\"";} ?>><?phpphp echo $BL->props->lang['subtruct']; ?></option>
                          </select>
                          </div>
                          </td>
                      </tr>
                      ...
                      <tr> 
                        ...
                        <td class='text_grey'>
                        <div id="form1_label">
                        <?phpphp echo $BL->props->lang['net']; ?> / <?phpphp echo $BL->props->lang['compounded']; ?>
                        </div>
                        <div id="form1_field">
                          <select name='tax_net_comp' class='search' id='tax_net_comp'>
                            <option value='N' <?phpphp if($cmd=="edittax"){if($tax['tax_net_comp']=="N") echo "selected=\"selected\"";} ?>><?phpphp echo $BL->props->lang['net']; ?></option>
                            <option value='C' <?phpphp if($cmd=="edittax"){if($tax['tax_net_comp']=="C") echo "selected=\"selected\"";} ?>><?phpphp echo $BL->props->lang['compounded']; ?></option>
                          </select>
                          </div></td>
                      </tr>
                      <tr> 
                      ...
                      <tr> 
                        ...
                        <div id="form1_label">
                        <?phpphp echo $BL->props->lang['Country']; ?>
                        </div>
                        <div id="form1_field">
                          <select name='tax_country[]' class='search' id='tax_country[]' size='10' multiple='true' onchange="javacript:if(NumberOfSelection('tax_country[]','form1')==1)updateTaxStates(this.options[this.selectedIndex].value);else getObj('tax_state[]','form1').options.length = 1;">
                            <option value='ALL' <?phpphp if($cmd=="edittax"){if($tc_array=="ALL") echo "selected=\"selected\"";} ?>><?phpphp echo $BL->props->lang['all']; ?></option>
                            <?phpphp foreach($BL->props->country as $x=>$y) {  ?>
                                <option value='<?phpphp echo $x; ?>' <?phpphp if($cmd=="edittax" && is_array($tc_array) && array_search($x, $tc_array)!==false) echo "selected=\"selected\""; ?>><?phpphp echo $y; ?></option>
                            <?phpphp } ?>
                          </select>
                          </div></td>
                      </tr>
                      ...
                      <tr> 
                        ...
                        <td class='text_grey' valign='top'>
                        <div id="form1_label">
                        <?phpphp echo $BL->props->lang['State']; ?>
                        </div>
                        <div id="form1_field">
                          <select name='tax_state[]' class='search' id='tax_state[]' size='10' multiple='true'>
                            <option value='ALL' <?phpphp if($cmd=="edittax"){if($ts_array=="ALL") echo "selected=\"selected\"";} ?>><?phpphp echo $BL->props->lang['all']; ?></option>
                          </select>                 
                        </div>
                        </td>
                      </tr>
                      ...
                      <tr> 
                        ...
                        <div id="form1_field">
                          <?phpphp if($cmd=="edittax"){ ?>
                          <input name='tax_id' type='hidden' value='<?phpphp echo $tax['tax_id']; ?>' />
                          <?phpphp } ?>
                          <input type='hidden' name='cmd' value='<?phpphp echo $cmd; ?>' />
                          <input name='submit' type='submit' class='search1' value='<?phpphp if($cmd=="edittax")echo $BL->props->lang['Update'];else echo $BL->props->lang['add']; ?>' />                          </div></td>
                      </tr>
                    </table>
                  </form>
                    </td>
...
<?phpphp if(count($tc_array)==1) { ?>updateTaxStates('<?phpphp echo $tc_array[0]; ?>');<?phpphp } ?>
</script> 
<!--end content -->
<div id="navBar">
