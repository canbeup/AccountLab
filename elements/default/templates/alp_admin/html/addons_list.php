...
<div id="content">
    <div id="display_list">
      <div class="tabs2" name='tt1' id='tt1' onmouseover="javascript:this.className='tabs1';" onmouseout="javascript:this.className='tabs2';" ><?phpphp echo $BL->props->lang['~addons']; ?></div>
      <div class="tab_separator">&nbsp;</div>
      <div class="tabs" name='tt2' id='tt2' onmouseover="javascript:this.className='tabs1';" onmouseout="javascript:this.className='tabs';" ><a href="admin.php?cmd=add_addon" class="add_link"><?phpphp echo $BL->props->lang['Add_addon']; ?></a></div>
      <div class="tab_separator">&nbsp;</div>
    </div>
	<div id="display_list">
		...
		?>
				<tr>
					<td class="text_grey" colspan="3">
                    	<div align='center'>
                    	<?phpphp echo $BL->props->lang['No_addons']; ?>
                    	</div>
					</td>
				</tr>
		<?phpphp
		...
		?>
					<td class='text_grey' width="1%"></td>
                      <td class='text_grey'>
					  <b><?phpphp echo $BL->props->lang['Name']; ?></b></td>
					...
					<td class='text_grey' width="1%"></td>
                      <td class='text_grey'>
					  <?phpphp echo $temp['addon_name']; ?></td>
                      <td class='text_grey' width='10%'><div align='right'>
                      <?phpphp if($BL->getCmd("edit_addon")){ ?>
                      <a href='<?phpphp echo $PHP_SELF; ?>?cmd=edit_addon&addon_id=<?phpphp echo $temp['addon_id']; ?>' class='text_link'><img src='elements<?phpphp echo PATH_SEP; ?>default<?phpphp echo PATH_SEP; ?>templates<?phpphp echo PATH_SEP; ?>alp_admin<?phpphp echo PATH_SEP; ?>images<?phpphp echo PATH_SEP; ?>edit_all.gif' alt='<?phpphp echo $BL->props->lang['Edit']; ?>' border='0'></a>
                      <?phpphp } ?>
                      &nbsp;
                      <?phpphp if($BL->getCmd("del_addon")){ ?>
                      <a href="javascript:if(confirm('<?phpphp echo $BL->props->lang['Do_you_want_to_delete_this_addon']; ?>'))document.location='<?phpphp echo $PHP_SELF; ?>?cmd=del_addon&addon_id=<?phpphp echo $temp['addon_id']; ?>'" class='text_link'><img src='elements<?phpphp echo PATH_SEP; ?>default<?phpphp echo PATH_SEP; ?>templates<?phpphp echo PATH_SEP; ?>alp_admin<?phpphp echo PATH_SEP; ?>images<?phpphp echo PATH_SEP; ?>delete.gif' alt='<?phpphp echo $BL->props->lang['Delete']."?"; ?>' border='0'></a>
                      &nbsp;
                      <?phpphp } ?>
                      &nbsp;</div></td>
                    </tr>
