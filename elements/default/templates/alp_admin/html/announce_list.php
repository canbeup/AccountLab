...
<div id="content">
    <div id="display_list">
      <div class="tabs2" name='tt1' id='tt1' onmouseover="javascript:this.className='tabs1';" onmouseout="javascript:this.className='tabs2';" ><?phpphp echo $BL->props->lang['~announce']; ?></div>
      <div class="tab_separator">&nbsp;</div>
      <div class="tabs" name='tt2' id='tt2' onmouseover="javascript:this.className='tabs1';" onmouseout="javascript:this.className='tabs';" ><a href="admin.php?cmd=addannounce" class="add_link"><?phpphp echo $BL->props->lang['+addannounce']; ?></a></div>
      <div class="tab_separator">&nbsp;</div>
    </div>
    <div id="display_list">
		...
		?>
				<tr>
					<td class="text_grey" colspan="3">
                    	<div align='center'>
                    	<?phpphp echo $BL->props->lang['No_announces']; ?>
                    	</div>
					</td>
				</tr>
		<?phpphp
		...
		?>
					<td class='text_grey' width="1%"></td>
                      <td class='text_grey'>
					  <b><?phpphp echo $BL->props->lang['title']; ?></b></td>
					...
					<td class='text_grey' width="1%"></td>
                      <td class='text_grey'>
					  <?phpphp echo $val['an_title']; ?></td>
                      <td class='text_grey' width='10%'><div align='right'>
                      <?phpphp if($BL->getCmd("editannounce")){ ?>
                      <a href='<?phpphp echo $PHP_SELF; ?>?cmd=editannounce&ann_id=<?phpphp echo $val['ann_id']; ?>'><img src='elements<?phpphp echo PATH_SEP; ?>default<?phpphp echo PATH_SEP; ?>templates<?phpphp echo PATH_SEP; ?>alp_admin<?phpphp echo PATH_SEP; ?>images<?phpphp echo PATH_SEP; ?>edit_all.gif' alt='<?phpphp echo $BL->props->lang['Edit']; ?>' border='0'></a>
                      &nbsp;
                      <?phpphp } ?>
                      <?phpphp if($BL->getCmd("delannounce")){ ?>
                      <a href="javascript:if(confirm('<?phpphp echo $BL->props->lang['Do_you_want_to_delete_this_announce']; ?>'))document.location='<?phpphp echo $PHP_SELF; ?>?cmd=delannounce&ann_id=<?phpphp echo $val['ann_id']; ?>'"><img src='elements<?phpphp echo PATH_SEP; ?>default<?phpphp echo PATH_SEP; ?>templates<?phpphp echo PATH_SEP; ?>alp_admin<?phpphp echo PATH_SEP; ?>images<?phpphp echo PATH_SEP; ?>delete.gif' alt='<?phpphp echo $BL->props->lang['Delete']."?"; ?>' border='0'></a>
                      &nbsp;
                      <?phpphp } ?>                      
                      </div>
                      </td>
