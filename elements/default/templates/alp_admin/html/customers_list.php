...
<div id="content">
    <div id="display_list">
      <div class="tabs2" name='tt1' id='tt1' onmouseover="javascript:this.className='tabs1';" onmouseout="javascript:this.className='tabs2';" ><?phpphp echo $BL->props->lang['^customers']; ?></div>
      <div class="tab_separator">&nbsp;</div>
      <div class="tabs" name='tt2' id='tt2' onmouseover="javascript:this.className='tabs1';" onmouseout="javascript:this.className='tabs';" ><a href="admin.php?cmd=addcustomer" class="add_link"><?phpphp echo $BL->props->lang['~addcustomer']; ?></a></div>
      <div class="tab_separator">&nbsp;</div>
    </div>
    <div id="display_list">
    <?phpphp include_once $BL->props->get_page("templates/alp_admin/html/_customers.php"); ?>
    <table width="100%" border="0" cellspacing="2" cellpadding="2" class="list_table">  
        <tr> 
            <td class="text_grey" align="center">
                ...
                &nbsp;
                <img src='elements<?phpphp echo PATH_SEP; ?>default<?phpphp echo PATH_SEP; ?>templates<?phpphp echo PATH_SEP; ?>alp_admin<?phpphp echo PATH_SEP; ?>images<?phpphp echo PATH_SEP; ?>add_order.gif' border="0"> <?phpphp echo $BL->props->lang['Add_New_Order']; ?>
                &nbsp;
