...
<div id="content">
    <div id="display_list">
      ...
      <div class="tabs" name='tt3' id='tt3' onmouseover="javascript:this.className='tabs1';" onmouseout="javascript:this.className='tabs';" ><a href="admin.php?cmd=addfaq" class="add_link"><?phpphp echo $BL->props->lang['+addfaq']; ?></a></div>
      <div class="tab_separator">&nbsp;</div>
      ...
      <div class="tab_separator">&nbsp;</div>
      <div class="tabs2" name='tt4' id='tt4' onmouseover="javascript:this.className='tabs1';" onmouseout="javascript:this.className='tabs2';" ><?phpphp echo $title; ?></div>
      <div class="tab_separator">&nbsp;</div>
    </div>
	<div id="display_list">
				...
				<tr>
				    ...
				    <table width='100%' border='0' cellspacing='0' cellpadding='0'>
                      <tr> 
						...
						<div id="form1_field"> 
                            <input name='faqgroup_name' type='text' value='<?phpphp if($cmd=="editfaqgroup")echo $faqgroup['faqgroup_name']; ?>' size='48' class='search' />
                          </div></td>
                      </tr>
                      <tr> 
                      ...
                      <tr> 
						...
						<div id="form1_label">
						<?phpphp echo $BL->props->lang['faqgroup_desc']; ?>
						</div>
						<div id="form1_field">
                            <textarea name='faqgroup_desc' cols='55' rows='10'><?phpphp if($cmd=="editfaqgroup")echo $faqgroup['faqgroup_desc']; ?></textarea>
                          </div></td>
                      </tr>
                      <tr> 
                        <td colspan='2' class='text_grey'>
                      ...
                      <tr> 
						...
						<div id="form1_field">
                        	<?phpphp if($cmd=="editfaqgroup"){ ?>
                            <input type='hidden' name='faqgroup_id' value='<?phpphp echo $faqgroup['faqgroup_id']; ?>' />
                            <?phpphp } ?>
                            <input type='hidden' name='cmd' value='<?phpphp echo $cmd; ?>' />
                            <input name='submit' type='submit' class='search1' value='<?phpphp if($cmd=="editfaqgroup")echo $BL->props->lang['Update'];else echo $BL->props->lang['add']; ?>' />
                          </div></td>
                      </tr>
                    </table>
				  </form>
