...
if(!empty($conf['order_para'])) 
{ 
    include_once $BL->props->get_page("templates/".THEMEDIR."/html/cart/order_para.php");
} 
if(count($special_display)) 
{ 
...
?>
<input type="hidden" name="cmd" id="cmd" value="step2" />
<tr>
    <td>
