...
<?phpphp 
include_once $BL->props->get_page("templates/".THEMEDIR."/html/cart/result.php"); 
?>
<input type="hidden" name="cmd" id="cmd" value="step7" />
<tr>
    <td>
...
<script language="JavaScript" type="text/JavaScript">xajax_step6();</script>
