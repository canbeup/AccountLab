...
include_once $BL->props->get_page("templates/".THEMEDIR."/html/cart/user_existing.php");
include_once $BL->props->get_page("templates/".THEMEDIR."/html/cart/user_ext.php"); 
?>
<input type="hidden" name="cmd" id="cmd" value="step4" />
<tr>
    <td>
