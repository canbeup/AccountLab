...
include_once $BL->props->get_page("templates/".THEMEDIR."/html/cart/special_chooser.php"); 
?>
<input type="hidden" name="cmd" id="cmd" value="step6" />
<tr>
    <td>
...
<script language="JavaScript" type="text/JavaScript">xajax_step4();</script>
