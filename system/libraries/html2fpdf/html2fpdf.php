...
//if (!defined('RELATIVE_PATH')) define('RELATIVE_PATH',PATH_SYSTEM . "html2fpdf".PATH_SEP);
if (!defined('RELATIVE_PATH')) define('RELATIVE_PATH',LIBRARIES . "html2fpdf".PATH_SEP);
if (!defined('FPDF_FONTPATH')) define('FPDF_FONTPATH','font'.PATH_SEP);
