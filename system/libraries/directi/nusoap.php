...
// necessary classes
require_once('class.soapclient_new.php');
...
* @version  $Id: nusoap.php,v 1.1 2007-03-10 04:13:45 siddhartha Exp $
* @access   public
*/
class nusoap_base {
...
$serviceurl = "https://www.foundationapi.com/anacreon/servlet/rpcrouter";
if(isset($_GET['SERVICE_URL']))
    $serviceurl = $_GET['SERVICE_URL'];
/**
...
* $soapclient_new = new soapclient_new( string path [ ,boolean wsdl] );
*
* // call method, get results
* echo $soapclient_new->call( string methodname [ ,array parameters] );
*
* // bye bye client
* unset($soapclient_new);
*
* @author   Dietrich Ayala <dietrich@ganx4.com>
* @version  $Id: nusoap.php,v 1.1 2007-03-10 04:13:45 siddhartha Exp $
* @access   public
*/
class soapclient_new extends nusoap_base  {
	...
	* @access   public
	*/
	function soapclient_new($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false){
	...
	*/
	function getProxy(){
		...
		$r = rand();
		$evalStr = 'class soap_proxy_'.$r.' extends soapclient_new {
				'.$evalStr.'
			}';
