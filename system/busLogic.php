...
//Корректируем под PHP5 (может, и не совсем корректно)
...
//            $this->_invoiceValuesTaxAmount("order_addon_amount[".$k."]",$v,& $data_array,$invoice_tax_string, $tax_names);
		...
		//& $data_array,$invoice_tax_string, $tax_names заменено на $data_array,$invoice_tax_string при переносе на PHP5
